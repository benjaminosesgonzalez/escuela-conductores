...
const DashboardSecretaria = () => {
  ...
  const stats = [
    ...
    { icon: TrendingUp, label: 'Clases completadas', value: '342', color: '#f59e0b' },
  ];
  ...
  const actividadReciente = [
    ...
    { id: 4, tipo: 'profesor', nombre: 'Juan Pérez', accion: 'actualizó su disponibilidad', fecha: 'Hace 15 minutos' },
  ];
                ...
                >
                  <div style={{
                    ...
                    <span style={{
                      ...
                      fontSize: '11px',
                      fontWeight: '600',
                      backgroundColor: evento.tipo === 'alumno' ? '#dbeafe' : evento.tipo === 'profesor' ? '#dcfce7' : '#fef3c7',
                      color: evento.tipo === 'alumno' ? '#1e40af' : evento.tipo === 'profesor' ? '#166534' : '#92400e',
